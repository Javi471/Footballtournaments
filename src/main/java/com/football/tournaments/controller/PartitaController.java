...
public class PartitaController {
    ...
    // Detalle de un partido con sus comentarios. principal es null si no hay sesión
    ...
    public String dettaglio(@PathVariable Long id, Model model,
        ...
        // Solo si hay sesión muestro el formulario para comentar
        if (principal != null) {
    ...
    // Los ids de torneo, equipos y árbitro llegan como parámetros aparte
    ...
    // Guarda el resultado y marca el partido como jugado
